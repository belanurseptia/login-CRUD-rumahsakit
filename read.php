...
<body>
  ...
  <tbody>
    <?php
        ...
        $data=mysqli_query($rskoneksi, "SELECT * FROM pasien") or die(mysqli_error($rskoneksi));
        foreach($data as $baris){ ?>
        <tr>
            <td><?php echo $baris['idpasien']?></td> 
            <td><?php echo $baris['nama_pasien']?></td> 
            <td><?php echo $baris['dokter']?></td> 
            <td><?php echo $baris['kamar']?></td> 
            <td>
                <a href="update.php?idpasien=<?php echo $baris['idpasien']?>" 
                class="btn btn-info"><i class="bi bi-pencil-square"></i> Update</a>
                <a href="delete.php?idpasien=<?php echo $baris['idpasien']?>"
